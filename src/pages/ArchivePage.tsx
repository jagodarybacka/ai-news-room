    ...
    <>
      ...
      <section className="py-8">
        ...
        <input
          ...
          className="mt-4 w-full border-b border-foreground/30 bg-transparent py-2 font-serif text-lg placeholder:text-muted-foreground focus:border-foreground focus:outline-none"
        />
        {error && (
        ...
        {searching ? (
          ...
          <>
            {weeklyDates.length > 0 && (
              <>
                <h3 className="mt-6 text-xs font-medium uppercase tracking-[0.2em] text-muted-foreground">
                  Weekly editions
                </h3>
